    ...
    >
      ...
      >
        ...
        <div className={cn(
          ...
          <div className="absolute left-3 top-[52px] z-10 rounded-full border px-2.5 py-1 text-[9px] font-black tracking-tight shadow-sm backdrop-blur-md transition-transform duration-300 group-hover:scale-110 md:top-[56px]"
               style={{
          ...
          {/* Actions - Top Right */}
           <div className="absolute top-3 right-3 z-20 flex flex-col gap-2">
            ...
            <button
              ...
              className={cn(
                "group/like flex h-9 w-9 items-center justify-center rounded-full border shadow-lg transition-all hover:scale-110 active:scale-95",
            ...
            <SaveToBoardButton
              ...
              className="h-9 w-9 rounded-full border shadow-lg transition-transform hover:scale-110 active:scale-95"
            />
          </div>

          {/* Housepire Watermark - Bottom Right (Matching brand) */}
          <div
            className="absolute bottom-3 right-3 z-10 rounded-full border px-2.5 py-1 text-[9px] font-bold tracking-tight backdrop-blur-md"
            style={{
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-foreground/80 via-foreground/20 to-transparent p-4 pt-12 transition-opacity duration-300 group-hover:opacity-0">
        ...
        >
          <div className="flex flex-wrap gap-1.5 items-center">
            <span className="text-[10px] font-bold uppercase tracking-wider" style={{ color: 'var(--color-heading-secondary)' }}>
              {formatText(design.room_type)}
            </span>
            <span className="w-1 h-1 rounded-full bg-muted-foreground/30" />
            <span className="text-[10px] font-medium" style={{ color: 'var(--color-description)' }}>
               {formatText(design.style_primary)}
            </span>
          </div>
          <div className="flex items-center gap-1 text-[10px] font-semibold" style={{ color: 'var(--color-description)' }}>
